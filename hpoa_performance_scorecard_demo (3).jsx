...
function trend(values, higherIsBetter, metric) {
  ...
  if (!Number.isFinite(adjusted) || Math.abs(adjusted) < 0.5) {
    return { label: `Stable (${displayDelta})`, symbol: "→", direction: "stable", delta: adjusted };
  }

  return adjusted > 0
    ? { label: `Improving (${displayDelta})`, symbol: "↗", direction: "up", delta: adjusted }
    : { label: `Declining (${displayDelta})`, symbol: "↘", direction: "down", delta: adjusted };
}
      ...
      <div className="mx-auto max-w-7xl space-y-6">
        ...
        {activeTab === "input" && (
          <Card><div className="space-y-5 p-5">
            ...
            <div className="rounded-3xl bg-amber-50 p-4 text-sm text-amber-900 ring-1 ring-amber-200">Most count metrics are converted into per-shift values for fair comparison. Customer Recognition is intentionally shown as a cumulative recognition signal rather than a productivity metric.</div>
            ...
            <div className="space-y-5 p-5">
              <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                <div>
                  ...
                  <p className="text-sm text-slate-600">
                    Aggregated team-wide operational averages, medians, YTD quartile ranges and trends for Jan to {currentPeriodLabel}. Customer Recognition is excluded from this operational view.
                  </p>
                </div>
              ...
              <div className="grid gap-4 md:grid-cols-4">
                <div className="rounded-3xl bg-green-50 p-4 ring-1 ring-green-200">
                  <div className="text-sm text-green-700">Improving Metrics</div>
                ...
                <div className="rounded-3xl bg-red-50 p-4 ring-1 ring-red-200">
                  <div className="text-sm text-red-700">Declining Metrics</div>
              ...
              <div className="rounded-3xl border border-slate-200 bg-white p-5">
                <div>
                  ...
                  <p className="text-sm text-slate-600">Operational health by reporting month based on improving and declining operational metrics.</p>
                </div>
                      ...
                      <tr key={summary.metric.key} className="border-t border-slate-200">
                        ...
                        <td className="p-3">
                          <span className={cx("inline-flex items-center gap-1 rounded-full px-3 py-1 text-xs font-semibold", trendClass(summary.trend.direction))}>
                            {summary.trend.symbol} {summary.trend.label}
                          </span>
                        </td>
                      </tr>
                    ))}
          ...
          <Card>
            <div className="space-y-4 p-5">
              <div>
                ...
                <p className="text-sm text-slate-600">
                  Highlights where leadership presence, coaching support or operational awareness may add value. Customer Recognition remains informational only and does not trigger intervention signals.
                </p>
              </div>
